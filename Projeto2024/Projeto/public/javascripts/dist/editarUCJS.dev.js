...
$(function () {
  var docenteCount = 1; // Função para adicionar um novo conjunto de campos de docente
  ...
  $('#adicionar-docente').on('click', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field === 'email') {
        ...
        input.setAttribute('required', 'true'); // Preencher select com opções de email que não estão nos docentes já adicionados
        ...
        input.setAttribute('name', field + '-' + docenteCount);
        input.setAttribute('placeholder', 'Insira ' + field); // Torna o nome e o email obrigatórios
    ...
    docenteContainer.appendChild(removerButton); // Localiza o container onde os docentes serão adicionados dinamicamente

    var docentesAdicionados = document.getElementById('docentes-adicionados'); // Insere o novo container de docente antes do botão de adicionar docente
