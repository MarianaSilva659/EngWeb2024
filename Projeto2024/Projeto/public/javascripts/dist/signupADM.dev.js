...
$(document).ready(function () {
  //! Versão ainda só copiada do signup.js 16:38
  ...
  $('#formSubmit').click(function (event) {
    ...
    }); // constrói um JSON para enviarmos o pedido (o serialize mete os dados do formulário numa query string e isto serve para a transformar num objecto)
